...
if (! function_exists('boutik_local_avatar')) {
    /**
     * Génère un data-URI SVG (avatar avec initiales) — 100 % local,
     * sans aucune requête vers ui-avatars.com ni autre CDN.
     */
    function boutik_local_avatar(?string $name = '?', int $size = 64): string
    {
