		...
		<div class="lqd-about-plugins-wrap lqd-row lqd-page-reset-grid" style="--lqd-about-bg: #F4F4F4">
			<div class="lqd-col">
				<h5 class="lqd-page-reset-title">
					...
					<?php esc_html_e( 'Reset', 'aihub' ); ?>
				</h5>
				<p class="lqd-page-reset-desc"><?php esc_html_e( 'You can use Reset to delete your pages, posts, media and more in a few clicks.', 'aihub' ); ?></p>
				<h6><?php esc_html_e( 'You\'ll lose these:', 'aihub' ); ?></h6>
				<ul class="list list-minus">
					<li><?php esc_html_e( 'Pages, Posts, Custom Post Types', 'aihub' ); ?></li>
					<li><?php esc_html_e( 'Media Files', 'aihub' ); ?></li>
					<li><?php esc_html_e( 'Theme Settings, Sidebars, Widgets', 'aihub' ); ?></li>
				</ul>
				<div class="divider"></div>
				<h6><?php esc_html_e( 'You\'ll keep:', 'aihub' ); ?></h6>
				<ul class="list list-plus">
					<li><?php esc_html_e( 'Current Theme And Plugins', 'aihub' ); ?></li>
					<li><?php esc_html_e( 'Theme License', 'aihub' ); ?></li>
				</ul>
				<div class="divider"></div>
				...
				<form id="liquid-reset-form" action="<?php echo esc_url(admin_url('admin.php?page=liquid-reset'))?>" method="post" style="pointer-events:auto">
					<div class="form-field-checkbox">
						...
						<label for="liquid-reset"><?php esc_html_e( 'I understand that my data will be lost.' , 'aihub'); ?></label>
					</div>
				...
				<div class="notice-box-red">
					<?php
						printf( '%s <strong>%s</strong>', 
							esc_html__('Important: Please, keep in mind that it is not possible to recover your content once deleted.', 'aihub'),
							esc_html__('Make sure to backup your site before resetting.', 'aihub')
						);
					?>
				</div>
			</div>
	...
	<script type="text/template" id="tmpl-lqd-reset-modules">
		<div id="lqd-progress-popup" class="lqd-imp-popup-wrap is-active">
			<div class="lqd-imp-progress">
				<h6><?php esc_html_e( 'Resetting the WordPress', 'aihub' ); ?> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18"><path fill="none" d="M0 0h24v24H0z"/><path d="M3.055 13H5.07a7.002 7.002 0 0 0 13.858 0h2.016a9.001 9.001 0 0 1-17.89 0zm0-2a9.001 9.001 0 0 1 17.89 0H18.93a7.002 7.002 0 0 0-13.858 0H3.055z"/></svg></h6>
				<p><?php esc_html_e( 'This process may take a couple of minutes, do not close the page!', 'aihub' ); ?></p>
			</div>
		</div>
	</script>
