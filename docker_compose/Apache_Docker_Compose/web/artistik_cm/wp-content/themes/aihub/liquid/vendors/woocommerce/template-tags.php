...
?>
<div class="w-full lqd-shop-topbar-view-toggle mobile-extra:w-3/12">
	<ul class="lqd-woo-view-toggle inline-nav flex flex-wrap items-center list-none p-0 m-0">
	<?php
		global $wp;
...
$label      = liquid_helper()->get_kit_option( 'liquid_wc_widget_side_drawer_label' );
$sidebar_id = liquid_helper()->get_kit_option( 'liquid_wc_widget_side_drawer_sidebar_id' );
$only_mobile = liquid_helper()->get_kit_option( 'liquid_wc_widget_side_drawer_mobile' );
if( 'yes' === $only_mobile ) {
...
<div class="w-full lqd-shop-topbar-ajax-filter mobile-extra:w-3/12 <?php echo esc_html( $show_only_mobile_class ); ?>">
	<div class="lqd-woo-ajax-filter ld-module-sd ld-module-sd-left">

		<button
		class="nav-trigger style-5 flex relative items-center justify-center collapsed"
		role="button"
		type="button"
		data-ld-toggle="true"
		...
		aria-controls="lqd-product-filter-sidedrawer">
			<span class="bars d-inline-block relative z-1">
				...
				<div class="ld-sd-wrap">
					...
					<div class="ld-sd-inner">
						...
						<div id="woocommerce_product_categories-2" class="widget woocommerce widget_product_categories">
							<h3 class="widget-title"><?php esc_html_e( 'Product Categories', 'aihub' ) ?></h3>
...
<div class="w-3/12 lqd-shop-topbar-view-count mobile-extra:w-full">
	<ul class="lqd-woo-view-count flex-wrap items-center list-none p-0 m-0 postsperpage">

		<li><?php esc_html_e( 'Show:', 'aihub' ); ?> </li>
		<?php
