	...
	<div class="lqd-dsd-wrap">
		...
		<?php if ( ! class_exists( 'Liquid_Addons' ) ) : ?>
					...
					<div class="lqd-msg lqd-dsd-notice">
						<p><span><?php esc_html_e( 'Notice:', 'aihub' ); ?></span> <?php esc_html_e( 'Make sure to activate Hub Core plugin prior to import a demo.', 'aihub' ) ?></p>
					</div>

		<?php else: ?>

		<?php if ( 'valid' != get_option( 'aihub_purchase_code_status', false ) ) :
			
			echo '<div class="error"><p>' .
				sprintf( wp_kses( __( 'The %s theme needs to be registered. %sRegister Now%s', 'aihub' ), 'a' ), 'AIHub', '<a href="' . admin_url( 'admin.php?page=liquid') . '">' , '</a>' ) . '</p></div>';

		else: ?>
	
		<header class="lqd-dsd-header">
			<div class="lqd-dsd-header-inner">
				<h2><?php esc_html_e( 'Import a Demo', 'aihub' ); ?></h2>
				<p><?php esc_html_e( 'Choose a pre-built website for starting a quick design process.', 'aihub' ) ?></p>
			</div>
			<div class="lqd-msg lqd-dsd-notice">
				<p><span><?php esc_html_e( 'Important:', 'aihub' ); ?></span> <?php esc_html_e( 'Make sure to activate required plugins prior to import a demo.', 'aihub' ) ?></p>
			</div>
		</header>
							...
							<figure>
								...
								<div class="lqd-dsd-overlay">
									<a href="#" id="import-id" data-import-id="<?php echo esc_attr( $i ); ?>" data-demo-id="<?php echo esc_attr( $id ); ?>" class="lqd-btn lqd-import-popup">
										<span><?php esc_html_e( 'Import Demo', 'aihub' ); ?></span>
									</a>
									<a target="_blank" href="<?php echo esc_url( $demo['preview'] ); ?>" class="lqd-btn lqd-preview-btn">
										<span><?php esc_html_e( 'Preview', 'aihub' ); ?></span>
		...
		<script type="text/template" id="tmpl-demo-import-modules">
			<div id="lqd-progress-popup" class="lqd-imp-popup-wrap is-active">
				<div class="lqd-imp-progress">
					<h6><?php esc_html_e( 'Demo Importer', 'aihub' ); ?></h6>
					<p><?php esc_html_e( 'This process may take between 1-10 minutes depending on your server status. Please do not close the page.', 'aihub' ); ?></p>
					<div style="display:flex;flex-direction:column">
						<span class="lqd-import-step" id="liquid_set_demo_content"><?php esc_html_e( 'Content', 'aihub' ); ?>&nbsp;<span><?php esc_html_e( 'Importing...', 'aihub' ); ?></span></span>
						<span class="lqd-import-step" id="liquid_import_media"><?php esc_html_e( 'Media', 'aihub' ); ?>&nbsp;<span><?php esc_html_e( 'Importing...', 'aihub' ); ?></span></span>
						<span class="lqd-import-step" id="liquid_import_slider"><?php esc_html_e( 'Extras', 'aihub' ); ?>&nbsp;<span><?php esc_html_e( 'Importing...', 'aihub' ); ?></span></span>
						<span class="lqd-import-step" id="liquid_import_theme_options"><?php esc_html_e( 'Theme Options', 'aihub' ); ?>&nbsp;<span><?php esc_html_e( 'Importing...', 'aihub' ); ?></span></span>
						<span class="lqd-import-step" id="liquid_import_theme_widgets"><?php esc_html_e( 'Theme Widgets', 'aihub' ); ?>&nbsp;<span><?php esc_html_e( 'Importing...', 'aihub' ); ?></span></span>
						<span class="lqd-import-step" id="liquid_set_home_page"><?php esc_html_e( 'Home Page Setting', 'aihub' ); ?>&nbsp;<span><?php esc_html_e( 'Importing...', 'aihub' ); ?></span></span>
					</div>
				</div>
			</div>
		</script>
				...
				<div class="lqd-imp-popup-inner">
					...
					<div class="lqd-imp-popup-head">
						...
						<div class="lqd-imp-notes">
							<h6><%= title %></h6>
							<div class="lqd-msg lqd-dsd-notice">
								<p><span><?php esc_html_e( 'Important:', 'aihub' ); ?></span> <?php esc_html_e( 'This process will overwrite your current settings.', 'aihub' ); ?></p>
							</div>
						</div>
					...
					<div class="lqd-imp-popup-content lqd-row">
						...
						<div class="lqd-col lqd-col-7">
							<p><?php esc_html_e( 'Make sure to activate required plugins prior to import a demo.', 'aihub' ); ?></p>
						</div>
						...
						<div class="lqd-col lqd-col-12">
							...
							<div class="lqd-col lqd-col-6">
								<span class="lqd-imp-opt">
									...
									<span><?php esc_html_e( 'All Content', 'aihub' ); ?></span>
								</span>
							</div>
							...
							<div class="lqd-col lqd-col-6">
								<span class="lqd-imp-opt">
									...
									<span><?php esc_html_e( 'Media Attachments', 'aihub' ); ?></span>
								</span>
							</div>
							...
							<div class="lqd-col lqd-col-6" style="display:none;">
								<span class="lqd-imp-opt">
									...
									<span><?php esc_html_e( 'Revslider', 'aihub' ); ?></span>
								</span>
							</div>
							...
							<div class="lqd-col lqd-col-6" style="display:none;">>
								<span class="lqd-imp-opt">
									...
									<span><?php esc_html_e( 'Theme Options', 'aihub' ) ?></span>
								</span>
							</div>
							...
							<div class="lqd-col lqd-col-6">
								<span class="lqd-imp-opt">
									...
									<span><?php esc_html_e( 'Sidebars', 'aihub' ); ?></span>
								</span>
							</div>
							...
							<div class="lqd-col lqd-col-6">
								<span class="lqd-imp-opt">
									...
									<label for="lqd-imp-content"></label>
									<span><?php esc_html_e( 'Home Page', 'aihub' ); ?></span>
								</span>
							</div>
