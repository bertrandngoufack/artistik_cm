...
?>
<nav class="post-nav h5">

	<?php if( $prev_post_ID ) { ?>
	<div class="nav-previous">
		<a href="<?php echo esc_url( $prev_post_link ); ?>" rel="prev">
			<span class="screen-reader-text"><?php esc_html_e( 'Previous Article', 'aihub' ); ?></span>
			<span aria-hidden="true" class="nav-subtitle">
				...
				<?php esc_html_e( 'Previous Article', 'aihub' ); ?>
			</span>
	...
	<div class="nav-next">
		<a href="<?php echo esc_url( $next_post_link ); ?>" rel="next">
			<span class="screen-reader-text"><?php esc_html_e( 'Next Article', 'aihub' ); ?></span>
			<span aria-hidden="true" class="nav-subtitle">
				<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" stroke="#444" stroke-width="2" x="0px" y="0px" viewBox="0 0 24 24" xml:space="preserve" width="24" height="24">
				...
				<?php esc_html_e( 'Next Article', 'aihub' ); ?>
			</span>
