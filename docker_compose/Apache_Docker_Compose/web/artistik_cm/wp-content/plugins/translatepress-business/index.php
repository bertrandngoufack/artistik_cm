...
update_option( 'trp_license_key', 'C6D0D7F8DB6898D6ACA49DC6C9F4B996' );
update_option( 'trp_license_status', 'valid' );
update_option('trp_license_details', array('valid' => array((object) array('success' => true, 'license' => 'valid', 'item_id' => 0, 'item_name' => 'TranslatePress+Business', 'error' => '', 'checksum' => 'C6D0D7F8DB6898D6ACA49DC6C9F4B996', 'expires' => '2074-07-04'))));
...
function trp_business_update(){
    ...
    if (class_exists('TRP_EDD_SL_Plugin_Updater')) {
        ...
        $edd_updater = new TRP_EDD_SL_Plugin_Updater(TRP_BUSINESS_STORE_URL, __FILE__, array(
                'version' => '1.7.7',        // current version number
