...
<div>
	...
	<div id="frm_chat_options" class="with_frm_style <?php echo empty( $values['chat'] ) ? 'frm_hidden' : ''; ?>" style="margin-top: 15px;">
		...
		<div class="frm_grid_container">
			<div class="frm4">
				<label for="frm_chat_transition_type" class="frm_left_label">
					<?php esc_html_e( 'Transition type', 'formidable-chat' ); ?>
				</label>
			</div>
			<div class="frm8">
				<?php $transition_type = ! empty( $values['chat_transition_type'] ) ? $values['chat_transition_type'] : ''; ?>
				<select name="options[chat_transition_type]" id="frm_chat_transition_type">
					<option value="" <?php selected( $transition_type, '' ); ?>><?php esc_html_e( 'Horizontal', 'formidable-chat' ); ?></option>
					<option value="vertical" <?php selected( $transition_type, 'vertical' ); ?>><?php esc_html_e( 'Vertical', 'formidable-chat' ); ?></option>
					<option value="fade" <?php selected( $transition_type, 'fade' ); ?>><?php esc_html_e( 'Fade', 'formidable-chat' ); ?></option>
				</select>
			</div>
		</div>
