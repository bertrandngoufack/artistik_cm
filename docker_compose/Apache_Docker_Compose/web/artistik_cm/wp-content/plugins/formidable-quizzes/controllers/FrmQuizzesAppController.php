...
class FrmQuizzesAppController {
	 ...
	 * @var string
	 */
	public static $plug_version = '3.1.7';
	...
	public static function add_scripts() {
		...
		if ( self::should_load_form_action_js() ) {
		...
		if ( FrmAppHelper::is_admin_page( 'formidable-settings' ) ) {
			wp_enqueue_script( 'frmquizzes-settings', $url . '/js/frmquizzes-settings.js', array( 'jquery', 'wp-i18n' ), self::$plug_version );
		}
	}
	 ...
	 * @return bool
	 */
	private static function should_load_form_action_js() {
		$frm_action = FrmAppHelper::simple_get( 'frm_action', 'sanitize_title' );
		if ( 'show' === $frm_action && FrmAppHelper::is_admin_page( 'formidable-entries' ) ) {
			return true;
		}
		return 'settings' === $frm_action && FrmAppHelper::is_admin_page( 'formidable' );
	}
	...
	public static function load_textdomain() {
		load_plugin_textdomain( 'formidable-quizzes', false, basename( self::path() ) . '/languages/' );
	}
