<?php
class FrmAWeberCollection extends FrmAWeberResponse implements ArrayAccess, Iterator, Countable {
     ...
     * @return FrmAWeberEntry(Resource) The new resource created
     */
    ...
    public function offsetGet($offset) {
        ...
        # we have an entry, cast it to an FrmAWeberEntry and return it
        $entry_url = $this->adapter->app->removeBaseUri($entry['self_link']);
        return new FrmAWeberEntry($entry, $entry_url, $this->adapter);
    }
