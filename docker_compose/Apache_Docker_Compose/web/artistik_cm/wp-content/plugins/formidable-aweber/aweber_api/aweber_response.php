 ...
 * FrmAWeberResponse
 *
 * Base class for objects that represent a response from the FrmAWeberAPI. 
 * Responses will exist as one of the two FrmAWeberResponse subclasses:
 *  - FrmAWeberEntry - a single instance of an AWeber resource
 *  - FrmAWeberCollection - a collection of AWeber resources
 * @uses FrmAWeberAPIBase
 * @package 
 * @version $id$
 */
class FrmAWeberResponse extends FrmAWeberAPIBase {
     ...
     * __construct
     *
     * Creates a new FrmAWeberRespones
     *
