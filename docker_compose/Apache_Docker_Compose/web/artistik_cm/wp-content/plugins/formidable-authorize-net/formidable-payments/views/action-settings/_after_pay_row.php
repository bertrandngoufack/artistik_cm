<tr id="<?php echo esc_attr( $id ); ?>" class="frmtrans_after_pay_row frmtrans_after_pay_row_<?php echo absint( $atts['form_action']->ID ); ?>">
	<td><?php echo $action_control->after_payment_status( $atts ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></td>
	<td><?php echo $action_control->after_payment_field_dropdown( $atts ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></td>
	<td>
