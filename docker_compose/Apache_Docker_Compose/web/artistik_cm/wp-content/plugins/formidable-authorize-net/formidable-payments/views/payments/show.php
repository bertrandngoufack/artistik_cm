    ...
    <div id="poststuff" class="metabox-holder has-right-sidebar">
        ...
        <div id="post-body-content">
            ...
            <div class="postbox">
				...
				<h3 class="hndle"><span><?php esc_html_e( 'Payment', 'formidable-payments' ); ?></span></h3>
                <div class="inside">
                    <table class="form-table">
						<tbody>
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Status', 'formidable-payments' ); ?>:</th>
                            <td><?php echo esc_html( FrmTransAppHelper::show_status( $payment->status ) ); ?></td>
                        </tr>
						...
						<?php if ( ! empty( $payment->sub_id ) ) { ?>
	                        <tr valign="top">
	                            <th scope="row"><?php esc_html_e( 'Subscription', 'formidable-payments' ); ?>:</th>
								<td>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e( 'Amount', 'formidable-payments' ); ?>:</th>
