...
<div id="frm_posttax_<?php echo esc_attr( $tax_meta ); ?>" class="frm_posttax_row frm_grid_container">
	...
	<div class="frm1 frm_form_field frm-inline-select">
    	<a href="javascript:void(0)" class="frm_remove_tag" data-removeid="frm_posttax_<?php echo esc_attr( $tax_meta ); ?>" data-showlast=".frm_add_posttax_row.button" data-hidelast="#frm_form_action_<?php echo esc_attr( $action_control->number ); ?> .frm_posttax_labels"><?php FrmAppHelper::icon_by_class( 'frmfont frm_minus1_icon' ); ?></a>
    	<a href="javascript:void(0)" class="frm_add_tag frm_add_posttax_row"><?php FrmAppHelper::icon_by_class( 'frmfont frm_plus1_icon' ); ?></a>
	</div>
...
<?php if ( $selected_type !== 'tag' ) { ?>
    <div class="frm_exclude_cat_<?php echo esc_attr( $tax_meta ); ?> frm11 frm_form_field">
        ...
        <div class="frm_posttax_opt_list">
            ...
            <?php
			if ( $selected_type && $selected_type !== 'data' ) {
			?>
