...
use WPStaging\Pro\Push\Data\CleanupTemporaryLogins;
...
class Data extends DataJob
{
    ...
    protected function initializeSteps()
    {
        $this->steps = [
            ...
            CleanupTemporaryLogins::class, // Cleanup temporary users and their metadata (includes both wpstgtmpuser and wpstg_ patterns)
        ];
