...
class ManageSchedules
{
    ...
    public function editSchedule()
    {
        if (!$this->auth->isAuthenticatedRequest()) {
            wp_send_json_error("You are not allowed to perform this operation", 403);
        }

        if (empty($_POST['scheduleId']) || empty($_POST['formValues'])) {
            wp_send_json_error("Missing scheduled backup details", 400);
        }
                    ...
                    <div class="wpstg-advanced-options" style="text-align: left;">
                        ...
                        <div class="wpstg-advanced-options-site">
                            <div class="wpstg-backup-options-section">
                                <div class="wpstg-backup-scheduling-options wpstg-u-container">
                                        ...
                                        <div class="wpstg-edit-schedule-option">
                                            ...
                                            <select name="backupScheduleRecurrence" id="wpstgEditBackupScheduleRecurrence">
                                                ...
                                                <?php for ($day = 1; $day <= 7; $day++) :
                                                    ...
                                                    ?>
                                                <option <?php echo ($weeklyDay === $currentSchedule['schedule']) ? 'selected' : ''; ?> value="<?php echo esc_attr($weeklyDay); ?>"><?php echo esc_html(Cron::getCronDisplayName($weeklyDay)); ?></option>
                                                <?php endfor; ?>
                                        ...
                                        <div class="wpstg-edit-schedule-option">
                                            <div class="wpstg-edit-schedule-option-inner">
                                                ...
                                                <select name="backupScheduleRotation" id="wpstgEditBackupScheduleRotation">
                                                    <?php for ($i = 1; $i <= 10; $i++) : ?>
                                                        <option <?php echo ($i === (int)$currentSchedule['rotation']) ? 'selected' : ''; ?> value="<?php echo esc_attr((string)$i) ?>">
