...
/**
 * @deprecated Subsites Domain Path and Urls logic is now directly updated inside pro WPStaging\Pro\Staging\Tasks\StagingSite\DatabaseAdjustment\UpdateSubsitesDomainPathAndUrlsTask
 */
class SubsitesDomainPathAndUrlsUpdater
{
    /** @var string */
    const FILTER_CLONING_MULTISITE_SUBSITE_INFO = 'wpstg.cloning.multisite.subsite_info';
    ...
    protected function updateSubsitesInfo(): bool
    {
        ...
        foreach ($this->getSites() as $site) {
            ...
            $subsiteInfo   = Hooks::applyFilters(self::FILTER_CLONING_MULTISITE_SUBSITE_INFO, $subsiteInfo, $site->blog_id, $stagingSiteURL, $subsiteHasWWWPrefix);
