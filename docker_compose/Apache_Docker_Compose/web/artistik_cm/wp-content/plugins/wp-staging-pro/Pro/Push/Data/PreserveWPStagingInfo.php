...
{
    /** @var string */
    const FILTER_AFTER_PUSH_OPTIONS_TO_DELETE = 'wpstg.after_push.options_to_delete';
    ...
    private function preserveStagingSites()
    {
        ...
        if ($query === false) {
            $this->log("Can not insert/update value $stagingSitesOption in " . $this->tmpOptionsTable . ' - db error: ' . $this->productionDb->last_error, Logger::TYPE_ERROR);
    ...
    {
        $optionsToDelete = (array)Hooks::applyFilters(self::FILTER_AFTER_PUSH_OPTIONS_TO_DELETE, [
