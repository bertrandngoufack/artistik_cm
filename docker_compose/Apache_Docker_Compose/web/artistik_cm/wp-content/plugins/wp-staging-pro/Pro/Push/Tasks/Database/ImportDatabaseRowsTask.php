...
/**
 * This class is responsible for importing database records from the dump in the temporary tables in current site database.
 * @see PrepareDatabaseRowsTask for creating the dump.
 */
class ImportDatabaseRowsTask extends PushTask
{
    /**
