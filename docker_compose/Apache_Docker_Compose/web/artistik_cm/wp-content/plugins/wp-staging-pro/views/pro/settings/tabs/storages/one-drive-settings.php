...
<fieldset>
    ...
    <div class="wpstg-bg-white dark:wpstg-bg-[#141b27] wpstg-provider-settings-container">
        <div class="wpstg-max-w-3xl wpstg-py-1 wpstg-space-y-6 wpstg-provider-settings-container-inner">
            <header>
                <h1 class="wpstg-text-2xl wpstg-font-semibold wpstg-text-slate-900 dark:wpstg-text-slate-100"><?php echo esc_html__('Microsoft OneDrive', 'wp-staging'); ?></h1>
                <p class="wpstg-mt-1 wpstg-text-sm wpstg-text-slate-600 dark:wpstg-text-slate-400"><?php echo esc_html__('Upload backup files to your Microsoft OneDrive account.', 'wp-staging'); ?></p>
            </header>
            ...
            <section class="wpstg-card wpstg-card-body">
                    ...
                    <p class="wpstg-mt-1 wpstg-text-sm wpstg-text-slate-600 dark:wpstg-text-slate-400"><?php echo esc_html__('Connect your Microsoft OneDrive account to enable backup uploads.', 'wp-staging'); ?></p>
                    <?php
                    if ($isOneDriveAuthenticated) {
                        ?>
                        <div class="wpstg-mt-4">
                            <strong class="wpstg-mr-10px">
                                <?php esc_html_e('You are authenticated to Microsoft OneDrive.', 'wp-staging');?>
                            </strong>
                        ...
                        $authURL = $oneDriveStorage->getAuthenticationURL($redirectTo);
                        ?>
                        <div class="wpstg-mt-4">
            ...
            <footer class="wpstg-text-sm wpstg-text-slate-600 dark:wpstg-text-slate-400">
                <?php echo sprintf(
                    ...
                    '<a href="https://wp-staging.com/privacy-policy/#oneDrive" target="_blank">' . esc_html__('Our privacy policy', 'wp-staging') . '</a>'
                ); ?>
            </footer>
        </div>
    </div>
