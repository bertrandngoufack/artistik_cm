...
<div class="frm_hidden">
	...
	?>
	<div id="frm_adv_info">
		<h3 class="frm-collapsible" aria-expanded="true">
			<?php esc_html_e( 'Customization', 'formidable-views' ); ?>
			<?php FrmAppHelper::icon_by_class( 'frmfont frm_arrowdown8_icon frm_svg13', array( 'aria-hidden' => 'true' ) ); ?>
		</h3>
		<div class="frm_grid_container frm-collapse-me frm-view-customization-tabs" role="group">
			<div id="frm_box_content_customization"><?php FrmViewsDisplaysController::mb_adv_info( $view ); ?></div>
		</div>	

		<h3 id="frm-single-view-custom-css-accordion-heading" class="frm-collapsible frm-collapsed" aria-expanded="false">
			<?php esc_html_e( 'View-Specific Custom CSS', 'formidable-views' ); ?>
			<?php FrmAppHelper::icon_by_class( 'frmfont frm_arrowdown8_icon frm_svg13', array( 'aria-hidden' => 'true' ) ); ?>
		</h3>

		<div class="frm_grid_container frm-collapse-me" role="group">
			<div id="frm-view-listing-page--custom-css--container">
				<textarea id="frm-view-listing-page--custom-css" rows="12" class="large-text code"></textarea>
			</div>
			<div id="frm-view-detail-page--custom-css--container" class="frm_hidden">
				<textarea id="frm-view-detail-page--custom-css" rows="12" class="large-text code"></textarea>
			</div>
		</div>
