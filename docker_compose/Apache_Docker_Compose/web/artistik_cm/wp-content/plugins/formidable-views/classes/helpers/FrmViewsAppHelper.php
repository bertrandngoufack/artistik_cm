...
class FrmViewsAppHelper {
	 ...
	 * @var string
	 */
	public static $plug_version = '5.10.1';
	...
	public static function is_on_views_listing_page() {
		global $pagenow;
		return 'edit.php' === $pagenow ? ! self::view_editor_is_active() : false;
	}
	...
	public static function emulate_legacy_view_editor() {
		...
		global $title;
		if ( is_null( $title ) ) {
			$title = 'Views'; // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
		}
