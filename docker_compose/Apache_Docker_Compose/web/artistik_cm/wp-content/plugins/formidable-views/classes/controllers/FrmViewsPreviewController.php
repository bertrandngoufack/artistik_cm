...
class FrmViewsPreviewController {
	...
	private function set_entries_for_preview() {
		...
		$limit         = '' === $limit ? $preview_limit : min( $limit, $preview_limit );
	...
	private function process_shortcodes( $entry, $content, $include_detail_link = false ) {
		...
		$preview_content = str_replace( '[entry_count]', $this->get_entry_count(), $preview_content );
		...
		FrmProContent::replace_entry_position_shortcode(
			array(
				'entry' => $entry,
				'view'  => $this->view,
			),
