...
class LikertController {
	...
	public static function show_likert_opts( $args ) {
			...
			<span class="frm_likert_bulk_edit_opts frm-bulk-edit-link">
				<a href="#" class="frm-bulk-edit-link" data-option-type="<?php echo esc_attr( $args['option_type'] ); ?>">
					...
					FrmAppHelper::icon_by_class(
						...
						array(
							'echo'       => true,
							'aria-label' => __( 'Bulk Edit', 'formidable-surveys' ),
						)
					);
					?>
					<span>
		...
		<?php
		if ( is_callable( 'FrmFieldsHelper::render_ai_generate_options_button' ) ) {
			FrmFieldsHelper::render_ai_generate_options_button( $args );
		}
	}
	...
	protected static function show_likert_single_row_opt_inputs( $args ) {
		...
		<a href="javascript:void(0);" class="frm_likert_delete_opt" data-skip-frm-js="1">
			<?php FrmAppHelper::icon_by_class( 'frm_icon_font frm_minus1_icon frm_svg15' ); ?>
		</a>

		<a href="javascript:void(0);" class="frm_likert_add_opt">
			<?php FrmAppHelper::icon_by_class( 'frm_icon_font frm_plus1_icon frm_add_tag frm_svg15' ); ?>
		</a>
		<?php
	}
