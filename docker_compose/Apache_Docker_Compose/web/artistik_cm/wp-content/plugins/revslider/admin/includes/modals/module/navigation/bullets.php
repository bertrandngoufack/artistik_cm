...
<sr-modal id="sr_module_bullets" class="sr--no--padding sr--panel--leftsidebar" view="navigationbullets" style="min-width:360px; width:auto" hasslideout="sr7-module-slideout-wrap">
    <sr-options-menu fourperrow>
        ...
        <sr-nav-btn data-sr-tabc="sr_nav_b_style" data-tab-target-group="1" class="sr--tab--call selected"><sr-icon-wrap><svg class="sr--icon" width="16" height="19.2" transform="translate(0,-1)"><use xlink:href="#Addon_Paintbrush"></use></svg></sr-icon-wrap><span><?php echo __('Skin & Style','revslider');?></span></sr-nav-btn>  
            ...
            <sr-nav-btn data-sr-tabc="sr_nav_b_behavior" data-tab-target-group="1" class="sr--tab--call"><sr-icon-wrap><svg class="sr--icon" width="19.2" height="19.2" transform="translate(0,-1)"><use xlink:href="#Addon_Reveal"></use></svg></sr-icon-wrap><span><?php echo __('View','revslider');?></span></sr-nav-btn>    
        ...
        <sr-wrap view="sr_nav_b_style" viewchild="navigationbullets" class="sr--tab--content sr--open" data-tab-target-group="1" id="sr_nav_b_style" style="max-width:330px; width:auto">
            <sr-separator>
                ...
                <sr-separator-body class="sr_nav_b_layoutuse"> 
                    <sr-drop wide data-v="" r="nav.bullets.t" viewchild="sr_nav_b_style" data-source="navigation" data-source-type="bullets" data-onset="editor.nav.skin.get" data-onsetparams="bullets" data-onchange="editor.nav.skin.update" data-onchangeparams="bullets">
                        <sr-drop-view>
                            <span class="sr--drop--value"><?php _e('Pick a Skin','revslider'); ?></span>
                            <span class="sr--form--otitle"><?php _e('Bullet Skin Type','revslider'); ?></span>
            ...
            <sr-separator>
                <sr-separator-head notoggle nohover>
                    ...
                    <sr-wrap inline class="sr--abs--top--right sr--allowpointer sr--mt--10">
                        ...
                        r="nav.bullets.ps"  viewchild="sr_nav_b_style" 
                            data-onchange="editor.nav.presets.reload" data-onchangeparams="bullets"                            
                            data-source="presets" data-source-type="navigation.bullets" 
                        ...
                        <sr-drop id="sr_nav_bullets_preset_drop"  class="sr--oicon" clean
                            r="nav.bullets.ps" viewchild="sr_nav_b_style"
                            data-onlyexport="true"                              
                            data-onchange="editor.nav.presets.save"
                            data-onpreset="editor.nav.presets.add" data-onpresetextend="editor.nav.presets.extendOption" data-onpresetparams="bullets" 
        ...
        <sr-wrap view="sr_nav_b_behavior" viewchild="navigationbullets" class="sr--tab--content" data-tab-target-group="1" id="sr_nav_b_behavior" style="max-width:330px; width:auto">
            <sr-separator>                  
                <sr-separator-body>
                    ...
                    --><sr-wrap wide basic class="sr--form--grp sr--mb--15"><sr-onoff viewchild="sr_nav_b_behavior" r="nav.bullets.i" class="sr--mr--10"></sr-onoff><span><?php _e('RTL Direction','revslider'); ?></span></sr-wrap>  
