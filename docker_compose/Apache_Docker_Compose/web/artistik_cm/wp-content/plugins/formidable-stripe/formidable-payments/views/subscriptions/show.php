                ...
                <div class="inside">
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td><?php echo esc_html( FrmTransAppHelper::show_status( $subscription->status ) ); ?></td>
                        </tr>
                        ...
                        <tr valign="top">
							...
							<td>
								<?php FrmTransPaymentsController::show_entry_link( $subscription ); ?>
							</td>
                        </tr>
                        ...
                        <tr valign="top">
							...
							<td>
								<?php FrmTransSubscriptionsController::show_receipt_link( $subscription ); ?>
							</td>
                        </tr>
						<?php } ?>
						...
						<tr valign="top">
							...
							<td>
								<?php echo esc_html( FrmTransAppHelper::format_the_date( $subscription->next_bill_date, $date_format ) ); ?>
							</td>
						</tr>

						<?php FrmTransAppHelper::show_in_table( $subscription->fail_count, __( 'Fail Count', 'formidable' ) ); ?>
						...
						<tr valign="top">
							...
							<td><?php echo esc_html( FrmTransAppHelper::get_test_mode_display_string( $subscription ) ); ?></td>
						</tr>
						<?php } ?>
