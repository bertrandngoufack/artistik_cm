        ...
        <div class="column">
            <nav class="breadcrumb" aria-label="breadcrumbs">
                <ul>
                    ...
                    <li class="is-active"><a href="#" aria-current="page">Nouvel Incident</a></li>
                </ul>
            </nav>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <form action="<?= base_url('admin/scolarite/discipline/store') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="columns">
                            <div class="column is-6">
                                    ...
                                    <div class="control">
                                        <div class="select is-fullwidth">
                                            <select name="incident_type" required>
                                                ...
                                                <option value="MINOR" <?= old('incident_type') == 'MINOR' ? 'selected' : '' ?>>Mineur</option>
                                                <option value="MAJOR" <?= old('incident_type') == 'MAJOR' ? 'selected' : '' ?>>Majeur</option>
                                                <option value="CRITICAL" <?= old('incident_type') == 'CRITICAL' ? 'selected' : '' ?>>Critique</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input class="input" type="date" name="incident_date" value="<?= old('incident_date', date('Y-m-d')) ?>" required>
                                    </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input class="input" type="time" name="incident_time" value="<?= old('incident_time') ?>">
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input class="input" type="text" name="location" value="<?= old('location') ?>" placeholder="Ex: Salle de classe, Cour de récréation...">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="column is-6">
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <textarea class="textarea" name="sanction" placeholder="Décrivez la sanction appliquée..." required><?= old('sanction') ?></textarea>
                                    </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input class="input" type="text" name="sanction_duration" value="<?= old('sanction_duration') ?>" placeholder="Ex: 1 heure, 1 jour, 1 semaine...">
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <textarea class="textarea" name="witnesses" placeholder="Listez les témoins de l'incident..."><?= old('witnesses') ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    <div class="control">
                                        <label class="checkbox">
                                            <input type="checkbox" name="parent_notified" value="1" <?= old('parent_notified') ? 'checked' : '' ?>>
                                            Parents notifiés
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <textarea class="textarea" name="description" rows="6" placeholder="Décrivez en détail l'incident disciplinaire..." required><?= old('description') ?></textarea>
                            </div>
