            ...
            <div class="columns">
                <div class="column is-4">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="content">
                                <p><strong>Nom:</strong> <?= esc($role['name']) ?></p>
                                <p><strong>Description:</strong> <?= esc($role['description']) ?></p>
                ...
                <div class="column is-8">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form action="<?= base_url('admin/securite/roles/' . $role['id'] . '/permissions') ?>" method="POST">
                                <?= csrf_field() ?>
                                ...
                                <div class="field is-grouped">
                                    ...
                                    <div class="control">
                                        <a href="<?= base_url('admin/securite/roles/' . $role['id']) ?>" class="button is-light">
