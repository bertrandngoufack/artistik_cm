...
<div class="container">
        ...
        <div class="column">
            <nav class="breadcrumb" aria-label="breadcrumbs">
                <ul>
                    ...
                    <li class="is-active"><a href="#" aria-current="page">Modifier Emploi du Temps</a></li>
                </ul>
            </nav>
            ...
            <p class="subtitle">Modifier les informations d'un cours existant</p>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-content">
            <form action="<?= base_url('admin/etudes/timetable/' . $timetable['id'] . '/update') ?>" method="POST">
                <?= csrf_field() ?>
                            ...
                            <div class="control">
                                <div class="select is-fullwidth">
                                    <select name="day_of_week" required>
                                        ...
                                        <option value="1" <?= (old('day_of_week', $timetable['day_of_week']) == '1') ? 'selected' : '' ?>>Lundi</option>
                                        <option value="2" <?= (old('day_of_week', $timetable['day_of_week']) == '2') ? 'selected' : '' ?>>Mardi</option>
                                        <option value="3" <?= (old('day_of_week', $timetable['day_of_week']) == '3') ? 'selected' : '' ?>>Mercredi</option>
                                        <option value="4" <?= (old('day_of_week', $timetable['day_of_week']) == '4') ? 'selected' : '' ?>>Jeudi</option>
                                        <option value="5" <?= (old('day_of_week', $timetable['day_of_week']) == '5') ? 'selected' : '' ?>>Vendredi</option>
                                        <option value="6" <?= (old('day_of_week', $timetable['day_of_week']) == '6') ? 'selected' : '' ?>>Samedi</option>
                                    </select>
                                </div>
                            </div>
    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="content">
                <div class="columns">
                    <div class="column is-6">
                        <h4 class="title is-5">📅 Détails du Cours</h4>
                        <table class="table is-fullwidth">
                            ...
                            <tr>
                                ...
                                <td><?= date('d/m/Y H:i', strtotime($timetable['created_at'])) ?></td>
                            </tr>
                            <tr>
                                <td><strong>Modifié le:</strong></td>
                                <td><?= date('d/m/Y H:i', strtotime($timetable['updated_at'])) ?></td>
                            </tr>
                            <tr>
                    ...
                    <div class="column is-6">
                        <h4 class="title is-5">⚠️ Attention</h4>
                        <ul>
                            <li>La modification d'un cours peut affecter d'autres emplois du temps</li>
                            <li>Vérifiez les conflits potentiels avant de sauvegarder</li>
                            <li>Les changements sont immédiatement appliqués</li>
                            <li>Consultez l'historique des modifications si nécessaire</li>
                        </ul>
                    </div>
                </div>
            </div>
