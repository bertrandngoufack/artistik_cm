        ...
        <div class="column is-12">
            ...
            <nav class="breadcrumb" aria-label="breadcrumbs">
                <ul>
                    ...
                    <li class="is-active"><a href="#" aria-current="page">Modifier la Classe</a></li>
                </ul>
            </nav>
            ...
            <div class="level">
                <div class="level-left">
                    <div class="level-item">
                        <h1 class="title">Modifier la Classe</h1>
                    </div>
                </div>
            ...
            <!-- Form -->
            <div class="box">
                <form action="<?= base_url('admin/etudes/classes/' . $class['id'] . '/update') ?>" method="post">
                    <?= csrf_field() ?>
                                ...
                                <select id="cycle_id" name="cycle_id" required>
                                    ...
                                    <?php foreach ($cycles as $cycle): ?>
                                        <option value="<?= $cycle['id'] ?>" 
                                                <?= (old('cycle_id', $class['cycle_id']) == $cycle['id']) ? 'selected' : '' ?>>
                                            <?= $cycle['name'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
