...
class App extends BaseConfig
{
     ...
     * --------------------------------------------------------------------------
     *
     * Configuration professionnelle basée sur les variables d'environnement
     * avec détection automatique d'IP et adaptation réseau
     */
    public function __construct()
    {
        parent::__construct();
        
        // Configuration baseURL depuis .env avec adaptation automatique
    ...
    /**
     * Configure la base URL de manière intelligente
     * - Utilise les variables .env si disponibles
     * - Détecte automatiquement l'IP si configuré pour l'auto-détection
    ...
    private function configureBaseURL(): void
    {
        ...
        // La valeur par défaut est déjà définie dans la propriété $baseURL
    }
     ...
     */
    public string $appName = 'KISSAI SCHOOL';
