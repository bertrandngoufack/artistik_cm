<?php
/**
 * Test de vérification complète du module Messagerie
 * Vérification de toutes les fonctionnalités et correction des erreurs
 */

echo "📱 VÉRIFICATION COMPLÈTE MODULE MESSAGERIE\n";
echo "==========================================\n\n";
...
try {
    ...
    if (file_exists($routesFile)) {
        ...
        $mainRoutes = [
            ...
            'discipline' => 'Route discipline (alternative)'
        ];
    ...
    // Test 11: Vérification des URLs spécifiques
    echo "\n🌐 Test 11: Vérification des URLs spécifiques\n";
    echo "---------------------------------------------\n";
    
    $specificURLs = [
        'http://localhost:8080/admin/messagerie' => 'Page d\'accueil',
        'http://localhost:8080/admin/messagerie/messages' => 'Liste messages',
        'http://localhost:8080/admin/messagerie/messages/create' => 'Nouveau message',
        'http://localhost:8080/admin/messagerie/templates' => 'Liste templates',
        'http://localhost:8080/admin/messagerie/templates/create' => 'Nouveau template',
        'http://localhost:8080/admin/messagerie/subscribers' => 'Gestion abonnés',
        'http://localhost:8080/admin/messagerie/settings' => 'Configuration',
        'http://localhost:8080/admin/messagerie/send-bulletin' => 'Envoi bulletins',
        'http://localhost:8080/admin/messagerie/discipline-notification' => 'Notification discipline',
        'http://localhost:8080/admin/messagerie/discipline' => 'Discipline (alternative)'
    ];
    
    foreach ($specificURLs as $url => $description) {
    ...
    echo "\n🎉 RÉSUMÉ FINAL VÉRIFICATION MODULE MESSAGERIE\n";
    echo "==============================================\n";
    ...
    echo "✅ URLs spécifiques: VÉRIFIÉES\n";
    ...
    echo "🔧 Erreur discipline corrigée: http://localhost:8080/admin/messagerie/discipline\n";
