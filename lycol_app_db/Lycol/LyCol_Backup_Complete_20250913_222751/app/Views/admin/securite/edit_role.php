        ...
        <div class="column is-12">
            ...
            <div class="card">
                <div class="card-content">
                    <form action="<?= base_url('admin/securite/roles/' . $role['id'] . '/update') ?>" method="POST">
                        <?= csrf_field() ?>
                        
                        <div class="field">
                            <label class="label">Nom du Rôle *</label>
                            <div class="control">
                                <input class="input" type="text" name="name" value="<?= old('name', $role['name']) ?>" required>
                            </div>
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <textarea class="textarea" name="description" required><?= old('description', $role['description']) ?></textarea>
                            </div>
